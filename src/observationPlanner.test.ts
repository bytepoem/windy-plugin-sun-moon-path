...
describe('observation planner', () => {
    ...
    it('builds factual evidence for the preferred astronomy windows', () => {
        ...
        const points = [
            weatherPoint(start.getTime(), {
                iconCode: 3,
                totalCloudPercent: 20,
                highCloudPercent: 12,
                mediumCloudPercent: 8,
                lowCloudPercent: 5,
                temperatureC: 18,
                dewPointC: 14,
                precipMm: 0,
            ...
            weatherPoint(end.getTime(), {
                iconCode: 3,
                totalCloudPercent: 60,
                highCloudPercent: 42,
                mediumCloudPercent: 28,
                lowCloudPercent: 18,
                temperatureC: 20,
                dewPointC: 15,
                precipMm: 1.2,
        ...
        expect(windows[0].evidence).toMatchObject({
            ...
            highCloudPercent: { minimum: 12, maximum: 42 },
            mediumCloudPercent: { minimum: 8, maximum: 28 },
            lowCloudPercent: { minimum: 5, maximum: 18 },
